            ...
            <div class="w-full mt-8 flex">
                ...
                <div class="lg:mr-8 flex-1 h-full ">
                    <div class="flex items-center shadow-lg bg-white px-12 mb-7 rounded-md justify-between">
                        <div class="flex">
                            <div class="font-bold flex h-20 items-center cursor-pointer px-3"> <p> مراجعة عامة </p></div>
                            <div class="font-bold flex text-curious-blue border-b-4 border-curious-blue h-20 items-center ml-8 cursor-pointer px-3"> <p> اضافة خدمة جديدة </p></div>
                        </div>
                        <div>
